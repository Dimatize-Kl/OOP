...
public class PlanetCrystals implements Runnable {
    ...
    @Override
    public void run() {
        while (mageFire.getRedCrystal() < 500 && magesAir.getRedCrystal() < 500 && mageFire.getWhiteCrystal() < 500 && magesAir.getWhiteCrystal() < 500) {
            //if (mageFire.getRedCrystal() < 500 && magesAir.getRedCrystal() < 500 && mageFire.getWhiteCrystal() < 500 && magesAir.getWhiteCrystal() < 500) {
            crystalGrowth();
            try {
                Thread.sleep(100);
    ...
    public synchronized void minusCrystal(int redCrystal1, int whiteCrystal1) {
